  ...
  const handleSubmit = useCallback(
    (event) => {
      ...
      if (!fullname || !email || !password || !password2) {
        setFormValidMessage("oopS!! All field are required ");
        return;
      }

      if (password !== password2) {
        setFormValidMessage("password dose not match!");
        return;
      }
      ...
      axios
        .post("https://hostel-management-two.vercel.app/admin/register", formData)
        .then((response) => {
