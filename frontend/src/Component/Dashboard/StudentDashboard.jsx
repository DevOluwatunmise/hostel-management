  ...
  const removeUser = async (_id) => {
    try {
      ...
      const response = await axios.delete(
        `https://hostel-management-two.vercel.app/student/delete-student/${_id}`
      );
      ...
      {isMoadalOpen && (
        <div className="modal">
          <div className="modal-content">
            ...
            <button
              onClick={() => handleModalSelected("ChangeStudentRoom")}
              className="two"
            >
              Change Student Room
            </button>
            <button
              onClick={() => handleModalSelected("UpdateCheckIn")}
              className="three"
            >
              Update Check-In
            </button>
